...
class EmployeeResourceIT {
    ...
    void createEmployee() throws Exception {
        ...
        assertThat(testEmployee.getHiredate()).isEqualTo(DEFAULT_HIREDATE);
    }
    ...
    void putNewEmployee() throws Exception {
        ...
        updatedEmployee.employeeId(UPDATED_EMPLOYEE_ID).firstName(UPDATED_FIRSTNAME).lastName(UPDATED_LAST_NAME).hiredate(UPDATED_HIREDATE);
        ...
        assertThat(testEmployee.getHiredate()).isEqualTo(UPDATED_HIREDATE);
    }
